...
gg_beta1 <- ggplot(data.frame(beta1 = extract(stan_fit_2, "beta[1,1]")$beta), aes(x = beta1)) +
  geom_density(fill = "blue", alpha = 0.6) +
  labs(title = "Density Plot of beta[1,1]", x = "beta[1,1]", y = "Density")

# Line plot using ggplot2
gg_a0_prob <- ggplot(data.frame(a0 = py$a0np, prob_dens = py$prob_dens), aes(x = a0, y = prob_dens)) +
  geom_line(color = "red") +
  geom_point(color = "brown", shape = 21, fill = "brown") +
  labs(title = "Line Plot of a0 vs. Probability Density", x = "a0", y = "Probability Density")

# Combine plots in a panel
gg_combined <- gg_beta1 + gg_a0_prob + theme_minimal() + theme(legend.position = "none")
